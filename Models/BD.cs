...
static public class BD
{
    ...
    public static void AgregarDeportista(string apellido, string nombre, DateTime fechaNacimiento, string foto, int idPais, int idDeporte, int calif)
    {
        string sql = "INSERT INTO Deportistas(Apellido, Nombre, FechaNacimiento, Foto, IdPais, IdDeportes, CalificacionOlimpica) VALUES (@pApellido, @pNombre, @pFecha, @pFoto, @pPais, @pDeporte, @pCalif)";
	    using(SqlConnection db = new SqlConnection(_connectionString))
	    {
		    db.Execute(sql, new {pApellido = apellido, pNombre = nombre, pFecha = fechaNacimiento, pFoto = foto, pPais = idPais, pDeporte = idDeporte, pCalif = calif});
	    }
    }
